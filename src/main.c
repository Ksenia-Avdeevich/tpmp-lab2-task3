...
int main(void) {
    ...
    GROUP gr5[MAX_STUDENTS] = {
        {"Ivanov I.I.",   {1993, 3, 15}, {8, 5, 4}},
        {"Petrov P.P.",   {1991, 6, 20}, {9, 6, 4}},
        {"Sidorov S.S.",  {1990, 11, 1}, {9, 10, 5}},
        {"Kozlov K.K.",   {1992, 8, 10}, {3, 10, 3}},
        {"Morozov M.M.",  {1994, 2, 28}, {8, 4, 4}},
        {"Sokolov S.S.",  {1989, 5, 5},  {5, 7, 5}},
        {"Novikov N.N.",  {1995, 7, 14}, {9, 9, 3}},
        {"Volkov V.V.",   {1988, 12, 31},{8, 5, 4}},
        {"Lebedev L.L.",  {1996, 1, 22}, {3, 6, 6}},
        {"Fedorov F.F.",  {1987, 9, 3},  {5, 6, 5}},
    };
    int n = MAX_STUDENTS;
